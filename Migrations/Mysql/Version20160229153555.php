...
class Version20160229153555 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE eventr_projections (name VARCHAR(255) NOT NULL, batchsize INT DEFAULT NULL, aggregatetype VARCHAR(255) DEFAULT NULL, synchronous TINYINT(1) NOT NULL, version INT NOT NULL, handlerclassname VARCHAR(255) NOT NULL, handleroptions LONGTEXT NOT NULL COMMENT '(DC2Type:json_array)', INDEX IDX_8E7FDDB886680307 (aggregatetype), PRIMARY KEY(name)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
