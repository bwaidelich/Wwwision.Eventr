...
class Version20160229153555 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE eventr_event_types (name VARCHAR(255) NOT NULL, aggregatetype VARCHAR(255) DEFAULT NULL, `schema` LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json_array)', INDEX IDX_5FD7AB9A86680307 (aggregatetype), PRIMARY KEY(name)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE eventr_event_types (name VARCHAR(255) NOT NULL, aggregatetype VARCHAR(255) DEFAULT NULL, `schema` LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json_array)', INDEX IDX_C217BE9786680307 (aggregatetype), PRIMARY KEY(name, aggregatetype)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE eventr_events (id INT AUTO_INCREMENT NOT NULL, stream VARCHAR(255) NOT NULL, version INT NOT NULL, saved_at DATETIME NOT NULL, type VARCHAR(255) NOT NULL, data LONGTEXT NOT NULL, metadata LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_4D906EE1F0E9BE1CBF1CD3C3 (stream, version), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
