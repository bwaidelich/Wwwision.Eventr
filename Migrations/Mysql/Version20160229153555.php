...
class Version20160229153555 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE wwwision_eventr_domain_model_eventtype (name VARCHAR(255) NOT NULL, aggregatetype VARCHAR(255) DEFAULT NULL, `schema` LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json_array)', INDEX IDX_C217BE9786680307 (aggregatetype), PRIMARY KEY(name)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		$this->addSql("CREATE TABLE wwwision_eventr_domain_model_projection (name VARCHAR(255) NOT NULL, aggregatetype VARCHAR(255) DEFAULT NULL, mapping LONGTEXT NOT NULL COMMENT '(DC2Type:json_array)', adapterconfiguration LONGTEXT NOT NULL COMMENT '(DC2Type:json_array)', INDEX IDX_EE7DA3F486680307 (aggregatetype), PRIMARY KEY(name)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
